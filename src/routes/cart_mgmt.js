...
router.post('/add_item', async function (req, res, next) {
    try {
        ...
        res.locals.data = await shopping_cart_handler.add_item(obj, user_id, item_id);
...
router.delete('/remove_item', async function (req, res, next) {
    try {
        ...
        res.locals.data = await shopping_cart_handler.remove_item(user_id, item_id);
...
router.get('', async function (req, res, next) {
    try {
        ...
        res.locals.data = await shopping_cart_handler.get_cart(user_id);
